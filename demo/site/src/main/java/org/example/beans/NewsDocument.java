...
public class NewsDocument extends HippoDocument {
     ...
     */
    public final static String DOCUMENT_TYPE = "demo:newsdocument";
    ...
    private final static String AUTHOR = "demo:author";
    private final static String SOURCE = "demo:source";
